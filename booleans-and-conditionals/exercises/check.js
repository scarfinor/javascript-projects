...
console.log('question (1) --------------')
console.log('whatDoesTheFollowingCodePrint?')
console.log('let a = 7')
console.log('if (a % 2 === 1)') 
console.log('console.log("Launch")')
console.log('else if (a > 5)') 
console.log('console.log("Code")')
console.log('else')
console.log('console.log("LaunchCode")')
console.log('answer: "Launch"')

console.log('(nestedConditionals) =======================')

console.log('question (1) --------------')
console.log('What is printed when the following code runs?')
console.log('let num = 7')
console.log('if (num % 2 === 0)')
console.log('   if (num % 2 === 1)')
console.log('console.log("odd")')
console.log("answer: 4.theCodeRunsButDoesn'tPrintAnything")
console.log('question (2) --------------')
console.log('consideringTheSameConditionalUsedInThePreviousQuestion,WhichValuesOfNumWouldResultIn"odd"BeingPrinted?')
console.log('if (num % 2 === 0)')
console.log('   if (num % 2 === 1)')
console.log('console.log("odd")')
